...
setwd("/home/laura/Documents/TFM/genwork/data_analysis/MP_16S_SRF_amplicons/MP_16S_amplicons_ss5000/")

#read data 
otu_tb16_5000 <- read.table(file="/home/laura/Documents/TFM/home/data/MALASPINA/16S_otu_table_no_hyphen.txt", head=TRUE, fill=TRUE)

#table dimensions and format before setting column names
#dim(otu_tb16_5000) # 1315   125
...
Regionally abundant OTUs (over 0.1% of frequence):

```{r abundant_OTUs, echo=3:6}
#regionally abundant
otu_tb16_ss5000_abundant<-otu_tb16_ss5000_rabund_percoccur[otu_tb16_ss5000_rabund_percoccur$mean_rabund > 0.001,]
otu_tb16_ss5000_abundant[order(-otu_tb16_ss5000_abundant[,1]),]

otu_tb16_ss5000_abundant_sorted_2<-otu_tb16_ss5000_abundant_sorted[order(otu_tb16_ss5000_abundant_sorted$mean_rabund, decreasing=T), c(1,2)]

otu_tb16_ss5000_abundant_sorted_2
