...
We can identify a prominent group in the middle-left side of the NMDS and a few isolated samples in the right edge of the plot. Considering the overall distribution, we're to identify any informative clustering pattern. The stress parameter takes a value below 0.3 (0.1503428), meaning that the plot is valid. 
...
Regionally abundant OTUs (abundance over 0.1%):

```{r abundant_OTUs, echo=6}
#regionally abundant
...
Percentage of cosmopolitan OTUs:

```{r percentage_cosmopolitan, echo=F}
(63/1138)*100
```

Number and percentage of rare OTUs:
