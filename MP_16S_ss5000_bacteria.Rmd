...
The Pielou index (constrained between 0 and 1) takes values closer to 1 as the variation of species proportion in a sample decreases. Most of our samples get values between 0.425 and 0.6, meaning that the numerical composition of different OTUs in each of our samples is relatively similar:
...
The Bray-Curtis dissimilarity (constrained between 0 and 1) allows us to quantify the differences between samples according to the composition and relative abundance of their OTUs. In our dataset, most of the samples pairs take dissimilarity values between 0.25 and 0.5, meaning that their composition has common.
