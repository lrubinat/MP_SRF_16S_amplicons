...
Most of the OTUs show very few occurrences, but we don't identify a massive group of rare OTUs:
...
We can identify a prominent group in the middle right side of the NMDS plot and a few isolated samples in the right edge of the plot. We cannot identify any informative clustering pattern. The stress parameter takes a value below 0.3 (0.1503428), meaning that the plot is valid. 
...
```{r OTUs_mean_relative_abund, echo=F, message=FALSE}
otu_tb16_t_ss5000_no_cero[1:5,1:5]
...
```{r OTUs_occurence, echo=F, message=FALSE}
...
```{r merge_rabund_peroccur, echo=F, message=FALSE}
...
Percentage of regionally abundant OTUs:
